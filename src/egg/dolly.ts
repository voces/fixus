import { DOLLY_TYPE, fillArray, fillArrayFn, TriggerRegisterPlayerUnitEventAll } from "shared";
...
const Trig_eggDolly_Actions = (): void => {
  ...
  if (dollyClick[playerId] > 10) {
    ...
    DestroyEffect(e);
    e = AddSpecialEffectTarget(
      "Objects\\Spawnmodels\\Human\\HumanLargeDeathExplode\\HumanLargeDeathExplode.mdx",
      GetTriggerUnit(),
      "origin",
    );
    DestroyEffect(e);
    ...
    DestroyEffect(e);
    e = AddSpecialEffectTarget(
      "Objects\\Spawnmodels\\Orc\\OrcSmallDeathExplode\\OrcSmallDeathExplode.mdx",
      GetTriggerUnit(),
      "origin",
    );
    DestroyEffect(e);
    ...
    if (katama) {
      ...
      CreateUnit(
        ...
        GetUnitFacing(GetTriggerUnit()) + 180,
      );
    }
