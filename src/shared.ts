...
export const isUnitSheep = (unit: unit): boolean => sheepTypes.includes(GetUnitTypeId(unit));

export const isUnitWolf = (unit: unit): boolean => wolfTypes.includes(GetUnitTypeId(unit));
