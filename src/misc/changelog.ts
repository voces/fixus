...
export const changelog = [
  ...
  { title: "Version 7d", content: ["Bug fixes", "• Can no longer gold allies gold you don't have"].join("\n") },
  {
    title: "Version 7c",
    content: ["Features", "• Sheep now spawn on the edges of the map", "• Wolves spawn at the same time of sheep."]
      .join("\n"),
  },
  { title: "Version 7b", content: ["Bug fixes", "• Copious Blood no longer gives insane HP"].join("\n") },
  {
    title: "Version 7",
    content: [
      "Balance",
