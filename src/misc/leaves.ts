...
import { countHere, mainUnit, sheepTeam, TriggerRegisterPlayerEventAll, wispTeam, wolfTeam } from "shared";
import { reloadMultiboard } from "util/multiboard";
import { colorizedName, isPlayingPlayer } from "util/player";
import { wrappedTriggerAddAction } from "util/emitLog";
import { setPlayerFlag } from "w3ts-w3mmd";
import { endGame, flagDesync } from "game/states/end";
...
const isSameTeam = (a: player, b: player): boolean => IsPlayerInForce(a, wolfTeam) === IsPlayerInForce(b, wolfTeam);
